...
e.getDate()!==i.getDate()&&i.getHours()>=6&&(delete t.goals,localStorage.setItem(config.key,JSON.stringify(t)))}},a.prototype.initialize=function(t,e){e.emit("change"),t.emit("change"),e.on("change",function(){s.save(e)}),t.on("change",function(){s.save(t)})},e.exports={initiate:function(t){this.instance=new a(t)}}},{"./ls":6,"./models/goals":8,"./models/settings":9,"./version":15,"./views/app":17}],2:[function(t,e,i){var n=t("./utils")
