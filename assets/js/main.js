...
n?n.addEventListener(e,i.bind(this)):console.warn("Node is not suitable for attaching events!")},s.extend=n(s),e.exports=s},{"./extend":11}],15:[function(t,e,i){var n=t("./helpers/events"),s=function(t){this.startTime=null,this.endTime=null,this.remained=null,this.timer=null,this.view=t}
...
e.exports=a.extend({initialize:function(){this.setupViews(),this.setupEvents(),this.update()},setupEvents:function(){var t=this,e=this.node,i=this.data.goals,n=this.timer.timer,s=new Audio("assets/sounds/bell.mp3")
...
e.exports=o},{"../helpers/language":3,"../helpers/math":4,"../mvc/view":14}],20:[function(t,e,i){var n=t("../mvc/view"),s=t("./ui-control"),r=t("../helpers/utils"),o=n.extend({initialize:function(){this.data.button.addEventListener("click",this.toggle.bind(this)),this.data.settings.on("change",this.render.bind(this))
...
e.exports=a},{"../helpers/math":4,"../mvc/model":13,"../mvc/view":14,"../timer":15}],22:[function(t,e,i){var n=t("../mvc/view"),s=n.extend({initialize:function(){var t=this.data.settings,e=this.find("input")
