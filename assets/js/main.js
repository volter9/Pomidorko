...
return s}({1:[function(t,e,i){var n=t("./models/settings"),s=t("./ls"),r=t("./models/goals"),o=t("./views/app"),a=function(t){this.resetIfNeeded(),this.settings=n.get(),this.goals=r.get(),this.view=new o(t,{settings:this.settings,goals:this.goals}),this.initialize(this.settings,this.goals)}
a.prototype.resetIfNeeded=function(){var t=s.storage
if(t&&t.goals&&t.goals.start){var e=new Date(t.goals.start),i=new Date
e.getDate()!==i.getDate()&&(delete t.goals,localStorage.setItem("pomidorka",JSON.stringify(t)))}},a.prototype.initialize=function(t,e){e.emit("change"),t.emit("change"),e.on("change",function(){s.save(e)}),t.on("change",function(){s.save(t)})},e.exports={initiate:function(t){this.instance=new a(t)}}},{"./ls":6,"./models/goals":8,"./models/settings":9,"./views/app":16}],2:[function(t,e,i){var n=t("./utils")
...
e.exports={toArray:h,extend:a,clone:r,merge:o,diff:s,each:n,pick:u}},{}],6:[function(t,e,i){var n=t("./mvc/mappers/ls")
e.exports=new n({key:"pomidorka"})},{"./mvc/mappers/ls":11}],7:[function(t,e,i){var n=t("../ls")
e.exports=function(t,e,i){return{get:function(){var i=new t
return n.fetch(e,i),i.isNew()&&(i=this.bootstrap(n)),i},bootstrap:function(t){var e=this.blank()
return t.insert(e),e},blank:function(){return new t(i)}}}},{"../ls":6}],8:[function(t,e,i){var n=t("../mvc/model"),s=t("./factory")
e.exports=s(n,"goals",{id:"goals",current:0,recess:!1,start:Date.now(),remained:!1})},{"../mvc/model":12,"./factory":7}],9:[function(t,e,i){var n=t("../mvc/model"),s=(t("../ls"),t("../helpers/math")),r=t("./factory"),o=n.extend({filter:function(t){t.time=s.clamp(t.time,5,55),t.shortBreak=s.clamp(t.shortBreak,3,10),t.longBreak=s.clamp(t.longBreak,5,45),t.total=s.clamp(t.total,1,1/0),t.round=s.clamp(t.round,1,t.total)}})
e.exports=r(o,"settings",{id:"settings",time:25,shortBreak:5,longBreak:15,round:4,total:12})},{"../helpers/math":3,"../ls":6,"../mvc/model":12,"./factory":7}],10:[function(t,e,i){var n=t("../helpers/utils"),s=function(t){return function(e){var i=function(){t.apply(this,n.toArray(arguments))}
...
this.options=s.merge(o,t),this.storage=JSON.parse(i.getItem(t.key))||{},this.on("change",function(){i.setItem(e.options.key,JSON.stringify(e.storage))})}
...
e.exports=s},{"../mvc/view":13}],16:[function(t,e,i){var n=t("./settings"),s=t("./goals"),r=t("./about"),o=t("./timer"),a=t("../mvc/view"),h=t("../helpers/utils")
...
window.addEventListener("keypress",function(e){32===e.keyCode&&(e.preventDefault(),t.timer.button())}),window.addEventListener("beforeunload",function(){var e=t.timer.timer.getRemained()
...
e.exports=a},{"../helpers/math":3,"../mvc/view":13}],18:[function(t,e,i){var n=t("../mvc/view"),s=t("./ui-control"),r=t("../helpers/utils"),o=n.extend({initialize:function(){this.data.button.addEventListener("click",this.toggle.bind(this)),this.data.settings.on("change",this.render.bind(this))
...
e.exports=a},{"../helpers/math":3,"../mvc/model":12,"../mvc/view":13,"../timer":14}],20:[function(t,e,i){var n=t("../mvc/view"),s=n.extend({initialize:function(){var t=this.data.settings,e=this.find("input")
