...
e.getDate()!==i.getDate()&&i.getHours()>=6&&(delete t.goals,localStorage.setItem("pomidorka",JSON.stringify(t)))}},a.prototype.initialize=function(t,e){e.emit("change"),t.emit("change"),e.on("change",function(){s.save(e)}),t.on("change",function(){s.save(t)})},e.exports={initiate:function(t){this.instance=new a(t)}}},{"./ls":6,"./models/goals":8,"./models/settings":9,"./views/app":16}],2:[function(t,e,i){var n=t("./utils")
...
e.exports=r(o,"settings",{id:"settings",time:25,shortBreak:5,longBreak:20,round:4,total:12})},{"../helpers/math":3,"../ls":6,"../mvc/model":12,"./factory":7}],10:[function(t,e,i){var n=t("../helpers/utils"),s=function(t){return function(e){var i=function(){t.apply(this,n.toArray(arguments))}
