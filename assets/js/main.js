...
a.prototype.resetIfNeeded=function(){var t=o.storage
if(t&&t.goals&&t.goals.start){var e=new Date(t.goals.start),i=new Date
e.getDate()!==i.getDate()&&i.getHours()>=6&&(delete t.goals,o.persist())}},a.prototype.initialize=function(t,e){e.emit("change"),t.emit("change"),e.on("change",function(){o.save(e)}),t.on("change",function(){o.save(t)})},e.exports={initiate:function(t){this.instance=new a(t,this.language)}}},{"./helpers/language":3,"./ls":7,"./models/goals":9,"./models/settings":10,"./version":17,"./views/app":19}],2:[function(t,e,i){var n=t("./utils")
...
return t.insert(e),e},blank:function(){return new t(i)}}}},{"../ls":7,"../version":17}],9:[function(t,e,i){var n=t("../mvc/model"),s=t("./factory")
e.exports=s(n,"goals")},{"../mvc/model":13,"./factory":8}],10:[function(t,e,i){var n=t("../mvc/model"),s=(t("../ls"),t("../helpers/math")),o=t("./factory"),r=n.extend({filter:function(t){t.time=s.clamp(t.time,5,55),t.shortBreak=s.clamp(t.shortBreak,3,10),t.longBreak=s.clamp(t.longBreak,5,45),t.total=s.clamp(t.total,1,1/0),t.round=s.clamp(t.round,1,t.total)}})
e.exports=o(r,"settings")},{"../helpers/math":4,"../ls":7,"../mvc/model":13,"./factory":8}],11:[function(t,e,i){var n=t("../helpers/utils"),s=function(t){return function(e){var i=function(){t.apply(this,n.toArray(arguments))}
return i.prototype=Object.create(t.prototype),n.each(e,function(t,e){i.prototype[e]=t}),i}}
e.exports=s},{"../helpers/utils":6}],12:[function(t,e,i){var n=t("../../helpers/events"),s=t("../../helpers/utils"),o=t("../model"),r={model:o},a=function(t){var e=this,i=window.localStorage
this.options=s.merge(r,t),this.storage=JSON.parse(i.getItem(t.key))||{},this.on("change",function(){e.persist()})}
...
n?n.addEventListener(e,i.bind(this)):console.warn("Node is not suitable for attaching events!")},s.extend=n(s),e.exports=s},{"./extend":11}],15:[function(t,e,i){e.exports={notify:function(t,e){!1 in window||"granted"!==Notification.permission||new Notification(t,{icon:e})},request:function(){!1 in window||"granted"===Notification.permission||Notification.requestPermission()}}},{}],16:[function(t,e,i){var n=t("./helpers/events"),s=function(t){this.startTime=null,this.remained=null,this.endTime=null,this.timer=null,this.view=t}
...
e&&e>=0&&i.set("remained",e)}),i.on("change",function(){e.classList.toggle("resting",i.get("recess"))}),s.on("stop",function(){n.get("sound")&&o.play()}),s.on("start",this.update.bind(this)),s.on("stop",this.stop.bind(this))},setupViews:function(){this.timer=new r(this.find(".pa-timer"),u.merge(this.data,{recess:this.find(".pa-skip span"),app:this})),this.goals=new s(this.find(".pa-goals"),this.data),this.about=new o(this.find(".pa-about"),{button:this.find(".pa-about-button")}),this.settings=new n(this.find(".pa-settings"),{settings:this.data.settings,button:this.find(".pa-settings-button")})},update:function(){var t=this.data.goals.get("recess"),e=t?"assets/img/break.ico":"assets/img/work.ico"
this.template=c.get(t?"recess":"work")+" — "+c.get("title","помидорковый таймер"),this.timer.timer.isRunning()||this.changeTitle(),document.querySelector("link[rel=icon]").href=e,document.querySelector(".pa-skip span").innerHTML=c.get("skip")[+t]},changeTitle:function(t){t=t?t+" ":"",document.title=t+this.template},stop:function(){var t=this.data.goals.get("recess"),e=t?"assets/img/break.ico":"assets/img/work.ico"
...
e.exports=o},{"../../helpers/utils":6,"../../mvc/view":14,"../../notify":15}],21:[function(t,e,i){e.exports={number:t("./number"),bool:t("./bool")}},{"./bool":20,"./number":22}],22:[function(t,e,i){var n=t("../../mvc/view"),s=n.extend({initialize:function(){var t=this.data.settings,e=this.find("input")
...
e.exports=s},{"../../mvc/view":14}],23:[function(t,e,i){var n=t("../mvc/view"),s=t("../helpers/math"),o=t("../helpers/language"),r=n.extend({initialize:function(){this.phrases=o.get("phrases"),this.data.goals.on("change",this.render.bind(this)),this.data.settings.on("change",this.render.bind(this))},randomPhrase:function(){return this.phrases[s.random(0,this.phrases.length-1)]},render:function(){var t=this.data.goals,e=this.data.settings,i=t.get("current"),n=(t.get("recess"),this.find(".pa-status")),s=e.get("total")
...
e.exports=r},{"../helpers/language":3,"../helpers/math":4,"../mvc/view":14}],24:[function(t,e,i){var n=t("../mvc/view"),s=(t("./ui-control"),t("../helpers/utils")),o=t("./controls"),r=n.extend({initialize:function(){this.data.button.addEventListener("click",this.toggle.bind(this)),this.data.settings.on("change",this.render.bind(this))
...
return new o[i](e,{settings:t})})},toggle:function(){var t=this.node.classList.contains("hidden")
...
this.renderTime(e,o.clamp(i,0,59)),this.renderScale(t,e,i)},renderScale:function(t,e,i){var n=t/60/55,s=3300*n,o=Math.floor(t)
t-o>.6&&this.timer.isRunning()&&this.settings.get("tick")&&this.old!==o&&(this.old=o,this.tick.play()),this.scale.style.marginLeft=-s+"px"},renderTime:function(t,e){t=r(t.toString(),"00"),e=r(e.toString(),"00"),this.find(".pa-min").innerHTML=t,this.find(".pa-sec").innerHTML=e,this.data.app.changeTitle(t+":"+e+" ·")},button:function(){var t=this.find(".pa-icon").classList.contains("pa-pause")
...
e.exports=a},{"../helpers/math":4,"../mvc/model":13,"../mvc/view":14,"../timer":16}],26:[function(t,e,i){var n=t("../mvc/view"),s=n.extend({initialize:function(){var t=this.data.settings,e=this.find("input")
this.input=e,this.bind(".plus","click",this.add),this.bind(".minus","click",this.sub),this.bind("input","change",function(){var i=parseInt(e.value)
t.set(e.className,isNaN(i)?0:Math.round(i))})},add:function(t){this.perform(t,1)},sub:function(t){this.perform(t,-1)},perform:function(t,e){t.preventDefault()
var i=parseInt(this.input.value)+e,t=document.createEvent("HTMLEvents")
