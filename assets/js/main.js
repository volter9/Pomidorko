...
return s}({1:[function(t,e,i){var n=t("./helpers/utils"),s=t("./helpers/ls"),o=t("./models/settings"),r=t("./mvc/model"),a=function(t,e){return n.merge(t.defaults[e],s.fetch(e))}
e.exports=function(t){var e=new o(a(t,"settings")),i=new r(a(t,"goals"))
return e.on("change",function(){s.save(e.id,e.all())}),i.on("change",function(){s.save(i.id,i.all())}),{settings:e,goals:i}}},{"./helpers/ls":24,"./helpers/utils":28,"./models/settings":30,"./mvc/model":32}],2:[function(t,e,i){var n=t("./component")
...
n.extend=t("../mvc/extend")(n),e.exports=n},{"../mvc/extend":31}],4:[function(t,e,i){var n=t("./component")
...
s.notify(o.get(t))}}})},{"../helpers/language":23,"../notify":34,"./component":3}],8:[function(t,e,i){var n=t("./component")
...
this.fields.forEach(function(e){e.set(t[e.input.className])})}})},{"../controls":19,"../helpers/utils":28,"../mvc/view":33,"./component":3}],11:[function(t,e,i){var n=t("./component"),s=t("../helpers/language")
...
this.button.innerHTML=t}})},{"../helpers/language":23,"./component":3}],12:[function(t,e,i){var n=t("./component")
e.exports=n.extend({constructor:function(t,e,i){this.timer=t,this.settings=e,this.sound=i},activate:function(){this.timer.on("stop",this.play.bind(this))},play:function(){this.settings.get("sound")&&this.sound.play()}})},{"./component":3}],13:[function(t,e,i){var n=t("./component")
...
return e&&t%this.settings.get("round")===0&&(n=this.settings.get("longBreak")),60*n}})},{"./component":3}],14:[function(t,e,i){var n=t("./component")
...
this.last!==e&&null!==this.last&&this.sound.play(),this.last=e}}})},{"./component":3}],15:[function(t,e,i){var n=t("./component"),s=t("../helpers/time")
...
e+=" · "+o.get(this.goals.get("recess")?"recess":"work"),e+=" — "+o.get("title","помидорковый таймер"),document.title=e}this.last=t.sec}})},{"../helpers/language":23,"../helpers/time":26,"./component":3}],17:[function(t,e,i){var n="1.0"
...
e.exports=o},{"../helpers/utils":28,"../mvc/view":33,"../notify":34}],19:[function(t,e,i){e.exports={number:t("./number"),bool:t("./bool")}},{"./bool":18,"./number":20}],20:[function(t,e,i){var n=t("../mvc/view"),s=n.extend({initialize:function(){var t=this.data.settings,e=this.find("input")
...
e.exports=s},{"../mvc/view":33}],21:[function(t,e,i){var n=document.createElement("div")
e.exports={toggle:function(t,e,i){i="undefined"==typeof i?!t.classList.contains(e):i,t.classList.toggle(e,i)},add:function(t,e){t.classList.add(e)},remove:function(t,e){t.classList.remove(e)},createNode:function(t){return n.innerHTML=t,n.children[0]},find:function(t,e){return e=e||document,e.querySelector(t)},findAll:function(t,e){return e=e||document,e.querySelectorAll(t)}}},{}],22:[function(t,e,i){var n=t("./utils")
...
this._events[t].forEach(function(t){t&&t.apply(t,e)})}},t}},{"./utils":28}],23:[function(t,e,i){e.exports={strings:{},set:function(t){this.strings=t},get:function(t,e){return t in this.strings?this.strings[t]:e}}},{}],24:[function(t,e,i){var n=t("../config"),s=window.localStorage
e.exports={storage:JSON.parse(s.getItem(n.key))||{},fetch:function(t){return this.storage[t]||{}},persist:function(){s.setItem(n.key,JSON.stringify(this.storage))},save:function(t,e){this.storage[t]=e,this.persist()},remove:function(t){delete this.storage[t],this.persist()}}},{"../config":17}],25:[function(t,e,i){e.exports={clamp:function(t,e,i){return t=Math.min(i,t),Math.max(e,t)},random:function(t,e){return Math.round(Math.random()*(e-t)+t)}}},{}],26:[function(t,e,i){var n=function(t,e){return e.substr(t.length)+t}
e.exports=function(t){var e=Math.floor(t/60),i=Math.floor(t%60)
return i=60>i?i:59,e=n(e.toString(),"00"),i=n(i.toString(),"00"),{min:e,sec:i}}},{}],27:[function(t,e,i){e.exports=function(t){return t=t||(t=0),function(){return++t}}},{}],28:[function(t,e,i){e.exports={each:function(t,e){for(var i in t)t.hasOwnProperty(i)&&e(t[i],i)},diff:function(t,e){var i={}
...
n?n.addEventListener(e,i.bind(this)):console.warn("Node is not suitable for attaching events!")}},s.extend=n(s),e.exports=s},{"./extend":31}],34:[function(t,e,i){e.exports={notify:function(t,e){!1 in window||"granted"!==Notification.permission||new Notification(t,{icon:e})},request:function(){!1 in window||"granted"===Notification.permission||Notification.requestPermission()}}},{}],35:[function(t,e,i){var n=t("./helpers/events"),s=function(t){this.startTime=null,this.remained=null,this.duration=null,this.endTime=null,this.timer=null,this.view=t}
s.prototype={start:function(t){t&&this.setDuration(t),this.timer||(t=this.remained?this.remained:1e3*this.duration,this.startTime=Date.now(),this.endTime=this.startTime+t,this.timer=setInterval(this.tick.bind(this),66),this.emit("start"))},setDuration:function(t){this.duration=t},tick:function(){var t=(this.endTime-Date.now())/1e3
return 0>t?(this.view&&this.view.render(0),this.emit("tick",0),this.stop()):(this.view&&this.view.render(t),void this.emit("tick",t))},pause:function(){clearInterval(this.timer),this.timer=null,this.remained=this.endTime-Date.now(),this.startTime=this.endTime=null},stop:function(){this.remained=this.endTime=this.startTime=null,clearInterval(this.timer),this.timer=null,this.emit("stop")},isRunning:function(){return Boolean(this.timer)},getRemained:function(){return this.remained?this.remained:this.endTime-Date.now()},getTime:function(){return this.remained?this.remained/1e3:this.duration},isTimeRemained:function(){return null!==this.remained}},n(s.prototype),e.exports=s},{"./helpers/events":22}]},{},[29])(29)})
