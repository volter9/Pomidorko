...
this.renderTime(e,o.clamp(i,0,59)),this.renderScale(t)},renderScale:function(t){var e=t/60/55,i=3300*e,n=Math.floor(t)
t-n>.6&&this.timer.isRunning()&&this.settings.get("tick")&&this.old!==n&&(this.old=n,this.tick.play()),this.scale.style.marginLeft=-i+"px"},renderTime:function(t,e){this.find(".pa-min").innerHTML=r(t.toString(),"00"),this.find(".pa-sec").innerHTML=r(e.toString(),"00")},button:function(){var t=this.find(".pa-icon").classList.contains("pa-pause")
