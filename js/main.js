...
t.on("change",function(){e.isTimeRemained()||e.isRunning()||i.render(60*t.get("time"))})},stop:function(){this.toggle(!0),this.render(0),this.next()},next:function(){var t=!this.goals.get("recess"),e=!t+this.goals.get("current"),i=!1
if(e>this.settings.get("total")&&(e=1,i=!0),this.goals.merge({recess:t,current:e}),!i){var n=t?this.settings.get("shortBreak"):this.settings.get("time")
t&&e%this.settings.get("round")===0&&(n=this.settings.get("longBreak")),this.toggle(!1),this.timer.start(60*n)}},render:function(t){var e=Math.floor(t/60).toString(),i=Math.floor(t%60).toString()
this.setTime(e,i),this.renderScale(t)},renderScale:function(t){var e=t/60/55,i=3300*e
this.scale.style.marginLeft=-i+"px"},setTime:function(t,e){t=o(t,"00"),e=o(e,"00"),this.label.innerHTML=t+":"+e},button:function(){var t=this.find(".icon").classList.contains("pause")
