...
e.exports={toArray:h,extend:a,clone:o,merge:r,diff:s,each:n,pick:u}},{}],6:[function(t,e,i){var n=t("./mvc/mappers/ls")
...
this.settings=this.data.settings,this.goals=this.data.goals,this.label=this.find("#timer-time"),this.scale=this.find(".timer-wrapper"),this.timer=new s(this),this.bind("#timer-control","click",this.button),this.timer.on("stop",function(){t.toggle(!0),t.render(0)}),this.render(60*this.settings.get("time"))},render:function(t){var e=Math.floor(t/60).toString(),i=Math.floor(t%60).toString()
this.setTime(e,i),this.renderScale(t)},renderScale:function(t){var e=t/60/55
pos=3300*e,this.scale.style.marginLeft=-pos+"px"},setTime:function(t,e){t=o(t,"00"),e=o(e,"00"),this.label.innerHTML=t+":"+e},button:function(){var t=this.find(".fa").classList.contains("fa-pause")
this.toggle(t),t?this.timer.pause():this.timer.start(60*this.settings.get("time"))},toggle:function(t){var e=this.find(".fa")
e.classList.toggle("fa-pause",!t),e.classList.toggle("fa-play",t),this.find("#timer-control").classList.toggle("play",t)}})
e.exports=r},{"../mvc/view":12,"../timer":13}],19:[function(t,e,i){var n=t("../mvc/view"),s=n.extend({initialize:function(){this.input=this.find("input"),this.bind(".fa-plus","click",this.add),this.bind(".fa-minus","click",this.sub)},add:function(t){this.perform(t,1)},sub:function(t){this.perform(t,-1)},perform:function(t,e){t.preventDefault()
