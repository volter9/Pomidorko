...
e.on("change",function(){t.classList.toggle("resting",e.get("recess"))}),this.timer=new r(this.find("#timer"),{settings:this.data.settings,recess:this.find(".pa-recess"),goals:this.data.goals}),this.goals=new s(this.find("#goals"),this.data),this.about=new o(this.find(".about"),{button:this.find("#about")}),this.settings=new a(this.find(".pa-settings"),{button:this.find(".pa-settings-button"),settings:this.data.settings}),this.timer.timer.on("start",function(){var t=!!e.get("recess")
document.title=(t?"Перерыв":"Работа")+" — помидорковый таймер",document.querySelector("link[rel=icon]").href=t?"img/break.ico":"img/work.ico"})}})
