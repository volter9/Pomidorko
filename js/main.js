...
e.exports=s},{"../mvc/view":12}],15:[function(t,e,i){var n=t("../mvc/view"),s=t("./goals"),o=t("./about"),r=t("./timer"),a=t("./settings"),h=n.extend({initialize:function(){var t=this.node,e=this.data.goals
e.on("change",function(){t.classList.toggle("resting",e.get("recess"))}),this.timer=new r(this.find("#timer"),{settings:this.data.settings,goals:this.data.goals}),this.goals=new s(this.find("#goals"),this.data),this.about=new o(this.find(".about"),{button:this.find("#about")}),this.settings=new a(this.find(".pa-settings"),{button:this.find(".pa-settings-button"),settings:this.data.settings}),this.timer.timer.on("stop",function(){document.title="Помидорковый Таймер - "+(e.get("recess")?"Перерыв":"Работай")})}})
...
e.exports=r},{"../helpers/utils":5,"../mvc/view":12,"./ui-control":19}],18:[function(t,e,i){var n=t("../mvc/view"),s=(t("../mvc/model"),t("../timer")),o=function(t,e){return e.substr(t.length)+t},r=n.extend({initialize:function(){this.settings=this.data.settings,this.goals=this.data.goals,this.label=this.find("#timer-time"),this.scale=this.find(".timer-wrapper"),this.timer=new s(this),this.setupEvents(),this.render(60*this.settings.get("time"))},setupEvents:function(){this.bind("#timer-control","click",this.button),this.timer.on("stop",this.stop.bind(this))
var t=this.settings,e=this.timer,i=this
t.on("change",function(){e.isTimeRemained()||e.isRunning()||i.render(60*t.get("time"))})},stop:function(){this.toggle(!0),this.render(0),this.next()},next:function(){var t=!this.goals.get("recess"),e=!t+this.goals.get("current"),i=e>this.settings.get("total")
console.log(t,e,i,this.settings.get("total")),this.goals.merge({recess:t,current:i?1:e}),i?this.render(60*this.settings.get("time")):this.startOver(e,t)},startOver:function(t,e){var i=e?this.settings.get("shortBreak"):this.settings.get("time")
e&&t%this.settings.get("round")===0&&(i=this.settings.get("longBreak")),this.toggle(!1),this.timer.start(60*i)},render:function(t){var e=Math.floor(t/60).toString(),i=Math.floor(t%60).toString()
this.setTime(e,i),this.renderScale(t)},renderScale:function(t){var e=t/60/55,i=3300*e
this.scale.style.marginLeft=-i+"px"},setTime:function(t,e){t=o(t,"00"),e=o(e,"00"),this.label.innerHTML=t+'<span class="colon">:</span>'+e},button:function(){var t=this.find(".icon").classList.contains("pause")
