...
var TimerView = View.extend({
    ...
    initialize: function () {
        ...
        this.tick  = new Audio('assets/sounds/tick.mp3');
     ...
     * @param {Number} time
     */
    renderScale: function (time, min, sec) {
    ...
    renderTime: function (min, sec) {
        ...
        this.find('.pa-min').innerHTML = min;
        this.find('.pa-sec').innerHTML = sec;
        
        this.data.app.changeTitle(min + ':' + sec + ' ·');
    },
